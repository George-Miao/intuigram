...
pub struct StoredChat {
    ...
    /// Whether opening this administrator-owned monoforum descends through
    /// per-user direct-message dialogs.
...
pub enum StoredMutation {
    ...
    /// Change whether one administrator-owned monoforum exposes its
    /// per-user direct-message dialogs.
    SetChatHasDirectMessages {
        /// Owning monoforum Chat.
        chat_id: i64,

        /// Whether the Account can manage all direct-message dialogs.
        has_direct_messages: bool,
    },
