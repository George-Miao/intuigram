    ...
    match media {
        ...
        SpecializedMediaView::Story(story) => StoredSpecializedMedia::Story {
            ...
            state: match story.state {
                intuigram_app::StoryStateView::Available => StoredStoryState::Available,
                intuigram_app::StoryStateView::Skipped => StoredStoryState::Skipped,
                intuigram_app::StoryStateView::Deleted => StoredStoryState::Deleted,
                intuigram_app::StoryStateView::Reference => StoredStoryState::Reference,
            },
