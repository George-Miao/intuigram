...
pub struct Client {
    ...
    pub(super) data_centers: DataCenterEndpoints,
    pub(super) media_data_centers: DataCenterEndpoints,
    pub(super) cdn_data_centers: DataCenterEndpoints,
    pub(super) media_sessions: Option<MediaSessions>,
    pub(super) venue_search_username: Option<String>,
    pub(super) venue_search_bot: Option<tl::enums::InputUser>,
}

/// Independently owned media access over a live Account invocation endpoint.
pub struct MediaClient(pub(super) Client);
...
impl MediaClient {
    ...
    pub async fn download_avatar(&mut self, avatar: AvatarRef) -> Result<Option<DownloadedMedia>> {
        self.0.download_avatar(avatar).await
    }
    ...
    pub async fn download_media(
        ...
        self.0.download_media(chat, message, locator).await
    }
    ...
    pub async fn download_media_preview(
        ...
        self.0.download_media_preview(chat, message, locator).await
    }
}
