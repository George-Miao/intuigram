pub(crate) fn text_with_entities(text: tl::enums::TextWithEntities) -> String {
...
pub(crate) const fn mark_channel_id(id: i64) -> i64 {
    -1_000_000_000_000 - id
}

pub(crate) const fn marked_peer_id(peer: &tl::enums::Peer) -> ChatId {
    match peer {
...
pub(crate) fn message_chat_id(message: &tl::enums::Message) -> ChatId {
    match message {
...
pub(crate) fn dialog_message_summary(
...
pub(crate) fn normalize_message(
    ...
    match message {
        ...
        tl::enums::Message::Message(message) => {
            ...
            let media_locator = message.media.as_ref().and_then(normalize_media_locator);
...
pub(crate) fn reply_message_id(header: &tl::enums::MessageReplyHeader) -> Option<MessageId> {
    match header {
...
pub(crate) fn message_body(message: &tl::enums::Message) -> String {
    match message {
...
pub(crate) fn normalize_entities(entities: Option<&[tl::enums::MessageEntity]>) -> Vec<TextEntity> {
    entities
        .unwrap_or_default()
        .iter()
