...
pub(in crate::source) fn render_with_graphics(
    frame: &mut Frame<'_>,
    view: &View,
    keymap: &EffectiveKeymap,
    options: ViewOptions,
...
pub(in crate::source) fn render_main(
    frame: &mut Frame<'_>,
    area: Rect,
    view: &View,
    options: ViewOptions,
...
pub(in crate::source) fn render_chats(
    frame: &mut Frame<'_>,
    area: Rect,
    view: &View,
    mode: ViewMode,
...
pub(in crate::source) fn render_active_chat(
    frame: &mut Frame<'_>,
    area: Rect,
    view: &View,
    options: ViewOptions,
