...
pub(in crate::source) const ACCOUNT_BINDINGS: &[Binding] = &[
    binding(
...
pub(in crate::source) fn render_account_picker(frame: &mut Frame<'_>, area: Rect, view: &View) {
...
pub(in crate::source) fn render_account_confirmation(
    frame: &mut Frame<'_>,
    area: Rect,
    view: &View,
) {
