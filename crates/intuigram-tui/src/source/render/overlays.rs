...
pub(in crate::source) fn render_delete_confirmation(
    frame: &mut Frame<'_>,
    area: Rect,
    view: &View,
) {
...
pub(in crate::source) fn render_link_confirmation(frame: &mut Frame<'_>, area: Rect, view: &View) {
...
pub(in crate::source) fn render_forward_picker(frame: &mut Frame<'_>, area: Rect, view: &View) {
...
pub(in crate::source) fn render_reaction_picker(frame: &mut Frame<'_>, area: Rect, view: &View) {
...
pub(in crate::source) fn render_poll_vote(frame: &mut Frame<'_>, area: Rect, view: &View) {
...
pub(in crate::source) fn render_todo_editor(frame: &mut Frame<'_>, area: Rect, view: &View) {
...
pub(in crate::source) fn render_overlay(frame: &mut Frame<'_>, area: Rect, lines: Vec<Line<'_>>) {
...
pub(in crate::source) const fn popup_content_area(area: Rect) -> Rect {
...
pub(in crate::source) fn render_attachment_path(frame: &mut Frame<'_>, area: Rect, view: &View) {
...
pub(in crate::source) fn render_save_as(frame: &mut Frame<'_>, area: Rect, view: &View) {
