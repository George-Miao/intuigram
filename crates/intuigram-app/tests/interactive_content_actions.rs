...
fn paid_message(available: bool) -> intuigram_lib::MessageView {
...
fn todo_message(completed: bool, appended: bool) -> intuigram_lib::MessageView {
    let mut message = incoming(82, "Lin", "[TODO list]");
    let mut items = vec![TodoItemView {
        id: 1,
        title: "Verify release".to_owned(),
        completed,
        completed_by: completed.then_some(intuigram_lib::ChatId(77)),
...
fn story_message(available: bool) -> intuigram_lib::MessageView {
...
fn giveaway_message(refreshed: bool) -> intuigram_lib::MessageView {
