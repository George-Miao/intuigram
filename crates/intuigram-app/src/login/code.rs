...
pub(crate) async fn sign_in_with_delivered_code(
    client: &mut Client,
...
pub(crate) fn login_code_delivery_message(delivery: &LoginCodeDelivery) -> String {
    match delivery {
...
pub(crate) const fn login_code_delivery_method_name(
