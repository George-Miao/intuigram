...
pub(in crate::application) fn seconds_until(expires_at: i32, server_time_offset: i32) -> u64 {
...
pub(in crate::application) fn unix_timestamp() -> i64 {
    SystemTime::now()
        .duration_since(UNIX_EPOCH)
        .map_or(0, |duration| {
...
pub(in crate::application) fn seconds_until_at(
    expires_at: i32,
    local_now: i64,
    server_time_offset: i32,
) -> u64 {
