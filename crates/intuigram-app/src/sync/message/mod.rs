...
use media::{StoredMediaLocator, cached_media_locator, stored_media_locator};
use serde::{Deserialize, Serialize};

use self::metadata::{StoredSpecializedMedia, cached_specialized_media, stored_specialized_media};

mod media;
mod metadata;

pub(super) use metadata::stored_paid_media_items_json;
...
struct StoredMessageMetadata {
    ...
    media_locator: Option<StoredMediaLocator>,
...
pub fn decode_stored_message(message: StoredMessage) -> MessageView {
    ...
    MessageView {
        ...
        details: MessageDetails {
            ...
            media,
            media_locator: metadata.media_locator.map(cached_media_locator),
