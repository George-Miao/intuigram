...
pub(crate) fn run_maintenance(
    ...
    match maintenance {
        ...
        Maintenance::Logout => unreachable!("logout is handled asynchronously"),
        Maintenance::Folder(_) => unreachable!("Folder maintenance is handled asynchronously"),
        Maintenance::RichMedia(_) => {
            unreachable!("rich media maintenance is handled asynchronously")
        }
        Maintenance::Scheduled(_) => {
